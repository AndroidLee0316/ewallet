 ...
 */
package com.pasc.lib.adapter.base;
...
import com.pasc.lib.adapter.base.animation.AlphaInAnimation;
import com.pasc.lib.adapter.base.animation.BaseAnimation;
import com.pasc.lib.adapter.base.animation.ScaleInAnimation;
import com.pasc.lib.adapter.base.animation.SlideInBottomAnimation;
import com.pasc.lib.adapter.base.animation.SlideInLeftAnimation;
import com.pasc.lib.adapter.base.animation.SlideInRightAnimation;
import com.pasc.lib.adapter.base.entity.IExpandable;
import com.pasc.lib.adapter.base.loadmore.LoadMoreView;
import com.pasc.lib.adapter.base.loadmore.SimpleLoadMoreView;
import com.pasc.lib.adapter.base.util.MultiTypeDelegate;
...
public abstract class BaseQuickAdapter<T, K extends BaseViewHolder> extends RecyclerView.Adapter<K> {
     ...
     */
    @Override
    public void onBindViewHolder(K holder, int pos) {
        //Add up fetch logic, almost like load more, but simpler.
        autoUpFetch (holder.getAdapterPosition ());
        //Do not move position, need to change before LoadMoreView binding
        autoLoadMore (holder.getAdapterPosition ());
        int viewType = holder.getItemViewType ();
        int position = 0;
        switch (viewType) {
            case 0:
                position = holder.getAdapterPosition () - getHeaderLayoutCount ();
