...
import com.pasc.lib.adapter.base.callback.ItemDragAndSwipeCallback;
import com.pasc.lib.adapter.base.listener.OnItemDragListener;
import com.pasc.lib.adapter.base.listener.OnItemSwipeListener;
    ...
    public void onBindViewHolder(K holder, int pos) {
        ...
        if (mItemTouchHelper != null && itemDragEnabled && viewType != LOADING_VIEW && viewType != HEADER_VIEW
            ...
            if (mToggleViewId != NO_TOGGLE_VIEW) {
                ...
                if (toggleView != null) {
                    toggleView.setTag(R.id.ewallet_BaseQuickAdapter_viewholder_support, holder);
                    if (mDragOnLongPress) {
                ...
                holder.itemView.setTag(R.id.ewallet_BaseQuickAdapter_viewholder_support, holder);
            ...
            mOnToggleViewLongClickListener = new View.OnLongClickListener() {
                ...
                public boolean onLongClick(View v) {
                    if (mItemTouchHelper != null && itemDragEnabled) {
                        mItemTouchHelper.startDrag((RecyclerView.ViewHolder) v.getTag(R.id.ewallet_BaseQuickAdapter_viewholder_support));
                    }
                    return true;
                }
            };
