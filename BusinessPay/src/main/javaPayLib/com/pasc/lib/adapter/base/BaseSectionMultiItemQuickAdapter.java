...
import com.pasc.lib.adapter.base.entity.MultiItemEntity;
import com.pasc.lib.adapter.base.entity.SectionMultiEntity;
    ...
    public void onBindViewHolder(K holder, int pos) {
        switch (holder.getItemViewType()) {
            case SECTION_HEADER_VIEW:
                setFullSpan(holder);
                convertHead(holder, getItem(holder.getAdapterPosition() - getHeaderLayoutCount()));
                break;
            default:
