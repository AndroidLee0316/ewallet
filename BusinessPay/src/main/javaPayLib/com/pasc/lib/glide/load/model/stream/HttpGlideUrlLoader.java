...
import com.pasc.lib.glide.load.data.HttpUrlFetcher;
import com.pasc.lib.glide.load.model.GlideUrl;
import com.pasc.lib.glide.load.model.ModelCache;
...
/**
 * An {@link com.pasc.lib.glide.load.model.ModelLoader} for translating {@link
 * com.pasc.lib.glide.load.model.GlideUrl} (http/https URLS) into {@link InputStream} data.
 */
// Public API.
