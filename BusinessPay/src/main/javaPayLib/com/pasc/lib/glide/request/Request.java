...
/**
 * A request that loads a resource for an {@link com.pasc.lib.glide.request.target.Target}.
 */
public interface Request {
   ...
   * {@link com.pasc.lib.glide.request.target.Target}s (for example). Using a similar but different
