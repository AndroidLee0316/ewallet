 ...
 *
 * <p> A new instance is
 * created per resource load by {@link com.pasc.lib.glide.load.model.ModelLoader}. {@link
 * #loadData(com.pasc.lib.glide.Priority, DataCallback)}
 ...
 * {@link #loadData(com.pasc.lib.glide.Priority,
...
public interface DataFetcher<T> {
   ...
   * finally block after the data provided by {@link #loadData(com.pasc.lib.glide.Priority,
   * DataCallback)} has been decoded by the
   * {@link com.pasc.lib.glide.load.ResourceDecoder}.
   *
   * <p> Note - this method will be run on a background thread so blocking I/O is safe. </p>
   */
  void cleanup();
  ...
  /**
   * Returns the {@link com.pasc.lib.glide.load.DataSource} this fetcher will return data from.
   */
  @NonNull
