...
final class HardwareConfigState {
   ...
   * and/or a sufficiently large {@link com.pasc.lib.glide.load.engine.cache.MemoryCache}, we can
  ...
  private static class SingletonHolder {
    private static final HardwareConfigState INSTANCE = new HardwareConfigState();
  }
