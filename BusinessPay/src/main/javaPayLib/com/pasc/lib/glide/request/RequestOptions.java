...
import com.pasc.lib.glide.load.MultiTransformation;
...
import com.pasc.lib.glide.load.resource.bitmap.CenterCrop;
import com.pasc.lib.glide.load.resource.bitmap.CenterInside;
import com.pasc.lib.glide.load.resource.bitmap.CircleCrop;
import com.pasc.lib.glide.load.resource.bitmap.DownsampleStrategy;
import com.pasc.lib.glide.load.resource.bitmap.Downsampler;
import com.pasc.lib.glide.load.resource.bitmap.DrawableTransformation;
import com.pasc.lib.glide.load.resource.bitmap.FitCenter;
import com.pasc.lib.glide.load.resource.bitmap.VideoDecoder;
import com.pasc.lib.glide.load.resource.gif.GifDrawable;
import com.pasc.lib.glide.load.resource.gif.GifDrawableTransformation;
import com.pasc.lib.glide.load.resource.gif.GifOptions;
import com.pasc.lib.glide.signature.EmptySignature;
...
public class RequestOptions implements Cloneable {
  ...
  /**
   * Applies a multiplier to the {@link com.pasc.lib.glide.request.target.Target}'s size before
   ...
   *                       {@link com.pasc.lib.glide.request.target.Target}'s dimensions when
   ...
   * {@link com.pasc.lib.glide.RequestBuilder#load(Object)} is {@code null}.
   *
  ...
  /**
   * Overrides the {@link com.pasc.lib.glide.request.target.Target}'s width and height with the
   ...
   * @return This request builder.
   * @see com.pasc.lib.glide.signature.ObjectKey
   */
  @NonNull
  @CheckResult
   ...
   * {@link com.pasc.lib.glide.TransitionOptions#dontTransition()}</p>
   */
  // Guaranteed to modify the current object by the isAutoCloneEnabledCheck.
  @SuppressWarnings("CheckResult")
  @NonNull
