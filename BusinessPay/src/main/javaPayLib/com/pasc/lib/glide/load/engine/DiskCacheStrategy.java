...
public abstract class DiskCacheStrategy {
   ...
   * {@link com.pasc.lib.glide.load.data.DataFetcher} and the
   * {@link com.pasc.lib.glide.load.EncodeStrategy} of the
   * {@link com.pasc.lib.glide.load.ResourceEncoder} (if an
   * {@link com.pasc.lib.glide.load.ResourceEncoder} is available).
   */
   ...
   * com.pasc.lib.glide.load.ResourceEncoder} will use to encode the resource.
   */
