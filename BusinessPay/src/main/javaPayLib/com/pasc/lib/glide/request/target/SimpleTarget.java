 ...
 * to the previous instance and either call {@link com.pasc.lib.glide.RequestManager#clear(Target)}
 * on the old instance before starting a new load or you must re-use the old instance for the new
 * load. Glide's {@link com.pasc.lib.glide.RequestBuilder#into(Target)} method returns the
 ...
 * calling {@link com.pasc.lib.glide.RequestManager#clear(Target)} and you should always null out
