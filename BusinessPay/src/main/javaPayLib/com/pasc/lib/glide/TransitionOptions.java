...
import com.pasc.lib.glide.request.transition.NoTransition;
import com.pasc.lib.glide.request.transition.TransitionFactory;
import com.pasc.lib.glide.request.transition.ViewAnimationFactory;
import com.pasc.lib.glide.request.transition.ViewPropertyAnimationFactory;
import com.pasc.lib.glide.request.transition.ViewPropertyTransition;
...
public abstract class TransitionOptions<CHILD extends TransitionOptions<CHILD, TranscodeType>,
   ...
   * {@link com.pasc.lib.glide.request.transition.Transition} for each request started with these
