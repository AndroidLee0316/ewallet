 ...
 *
 * @see com.pasc.lib.glide.manager.SupportRequestManagerFragment
 * @see com.pasc.lib.glide.manager.RequestManagerRetriever
...
public class RequestManagerFragment extends Fragment {
  ...
  /**
   * Returns the current {@link com.pasc.lib.glide.RequestManager} or null if none exists.
   */
  @Nullable
