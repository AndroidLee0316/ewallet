 ...
 * {@link com.pasc.lib.glide.load.ResourceDecoder} to decode a resource.
 */
public interface ModelLoader<Model, Data> {

  /**
   * Contains a set of {@link com.pasc.lib.glide.load.Key Keys} identifying the source of the load,
   ...
   * represented by this model, as well as a set of {@link com.pasc.lib.glide.load.Key Keys} that
   ...
   *               {@link com.pasc.lib.glide.request.target.Target#SIZE_ORIGINAL} to indicate that
