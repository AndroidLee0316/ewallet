...
import static com.pasc.lib.glide.gifdecoder.GifDecoder.TOTAL_ITERATION_COUNT_FOREVER;
...
public class GifDrawable extends Drawable implements GifFrameLoader.FrameCallback,
   ...
   * @param frameTransformation An {@link com.pasc.lib.glide.load.Transformation} that can be
   *                            applied to each frame.
   * @param targetFrameWidth    The desired width of the frames displayed by this drawable (the
   *                            width of the view or
   *                            {@link com.pasc.lib.glide.request.target.Target}
   ...
   * @see #setFrameTransformation(com.pasc.lib.glide.load.Transformation, Bitmap)
   *
