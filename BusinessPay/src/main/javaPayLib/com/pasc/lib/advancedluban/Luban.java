...
public class Luban {
    ...
    public void launch(final OnCompressListener listener) {
        asObservable().subscribeOn(AndroidSchedulers.mainThread()).doOnSubscribe(new Consumer<Disposable>() {
            @Override
    ...
    public void launch(final OnMultiCompressListener listener) {
        asListObservable().subscribeOn(AndroidSchedulers.mainThread()).doOnSubscribe(new Consumer<Disposable>() {
            @Override
            public void accept (Disposable disposable) {
                listener.onStart();
            }
