 ...
 * @modify
 **/
public class BillListFragmentYC extends BaseBillListFragment<BillListPresenter> implements BillListView, BillFailRollBackView {
    private final int pageSize = 20;
    private final int pageNumStart = 0;
    private int pageNum=pageNumStart;
    ...
    protected void initView() {
        ...
        recordListAdapter.setOnLoadMoreListener (new BaseQuickAdapter.RequestLoadMoreListener () {
            ...
            public void onLoadMoreRequested() {
                ...
                int tmpPageNum = pageNum + 1;
                loadMore (false,tmpPageNum);
            }
        }, recyclerView);
    ...
    void loadMore(boolean isRefresh,int pageNum) {
        if (isSearch) {
            if (Util.isEmpty (keyword)) {
                return;
            }
        ...
        mPresenter.getBillListYC (memberNo, tradeTypeId,preTradeTypeId, pageNum, pageSize, payYearMonth,prePayYearMonth, keyword);
    }
