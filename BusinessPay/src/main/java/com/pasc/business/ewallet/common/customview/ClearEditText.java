...
public class ClearEditText extends android.support.v7.widget.AppCompatEditText
    ...
    public interface InnerFocusChangeListener {
        ...
        void onInnerFocusChange(View v, boolean hasFocus);
    }
    ...
    private void init() {
        ...
        if (mClearDrawable == null) {
            mClearDrawable = getResources ().getDrawable (R.drawable.ewallet_del_edittext_icon);
        }
...
//            }
    ...
    public void afterTextChanged(Editable s) {
        ...
        if (editTextChangeListener != null && !notCallBack) {
            editTextChangeListener.afterChange (isEmpty (keyword) ? "" : keyword);
        }
        notCallBack=false;
    }
