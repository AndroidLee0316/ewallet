...
public class NumberPicker extends LinearLayout {
     ...
     */
    private static final int DEFAULT_LAYOUT_RESOURCE_ID = R.layout.ewallet_widget_number_picker;
...
//    private final Drawable mSelectionDivider;
    ...
    public NumberPicker(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray attributesArray = context.obtainStyledAttributes(
                attrs, R.styleable.EwalletNumberPicker, defStyle, 0);
        final int layoutResId = R.layout.ewallet_widget_picker_with_selector_wheel;
...
//        }
        ...
        mSelectionDividersDistance = attributesArray.getDimensionPixelSize(
                R.styleable.EwalletNumberPicker_ewallet_selectionDividersDistance, defSelectionDividerDistance);

        mMinHeight = attributesArray.getDimensionPixelSize(
                R.styleable.EwalletNumberPicker_ewallet_internalMinHeight, SIZE_UNSPECIFIED);

        mMaxHeight = attributesArray.getDimensionPixelSize(
                R.styleable.EwalletNumberPicker_ewallet_internalMaxHeight, SIZE_UNSPECIFIED);
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            mVirtualButtonPressedDrawable = getResources().getDrawable(R.drawable.ewallet_widget_item_background_holo_dark, null);
        } else {
            mVirtualButtonPressedDrawable = getResources().getDrawable(R.drawable.ewallet_widget_item_background_holo_dark);
        }
        ...
        // input text
        mInputText = findViewById(R.id.piac_numberpicker_input);
        ...
        mSelectionDividerPaint.setColor(context.getResources().getColor(R.color.ewallet_theme_color));
...
//            int color = Color.argb(0xff, 0x00, 0x00, 0x00);
            int color =getResources().getColor(R.color.ewallet_dialog_primary);
