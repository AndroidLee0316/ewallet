...
public class SharePreUtil {
    private final static String updateShareName = "ewallet_pay_prefer";
    ...
    private static SharedPreferences getShared() {
        return PayManager.getInstance ().getApplication ().getSharedPreferences(updateShareName, Context.MODE_PRIVATE);
    }
