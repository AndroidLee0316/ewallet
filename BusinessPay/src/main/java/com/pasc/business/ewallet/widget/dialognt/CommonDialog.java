package com.pasc.business.ewallet.widget.dialognt;
...
import com.pasc.business.ewallet.widget.ScreenUtils;
...
public class CommonDialog extends Dialog {
    ...
    public static final String Blue_3B68E9 = "#3B68E9";
    ...
    @StringDef({Black_333333, Gray_999999, Red_f14431, Blue_3B68E9, Transparent_00000000})
    ...
    private void initView() {
        ...
        switch (type) {
            case Common_Center:
                contentView = LayoutInflater.from(getContext()).inflate(R.layout.ewallet_widget_dialog_common_center, null);
                ...
                tvButton1 = findViewById(R.id.tv_button1);
                vDivider = findViewById(R.id.v_divider);
                tvButton2 = findViewById(R.id.tv_button2);
                break;
            case Common_Bottom:
                contentView = LayoutInflater.from(getContext()).inflate(R.layout.ewallet_widget_dialog_common_bottom, null);
                setContentView(contentView);
                params = (ViewGroup.MarginLayoutParams) contentView.getLayoutParams();
                ...
                tvButton1 = findViewById(R.id.tv_button1);
                tvButton2 = findViewById(R.id.tv_button2);
                tvButton3 = findViewById(R.id.tv_button3);
                vDivider1 = findViewById(R.id.v_divider1);
                vDivider2 = findViewById(R.id.v_divider2);
                vDivider3 = findViewById(R.id.v_divider3);
                break;
            case Common_Top:
                contentView = LayoutInflater.from(getContext()).inflate(R.layout.ewallet_widget_dialog_common_top, null);
                setContentView(contentView);
                params = (ViewGroup.MarginLayoutParams) contentView.getLayoutParams();
    ...
    private void initCommonBottom() {
        int cornerSize = DensityUtils.dp2px(3);
        //设置内容，如果没有设置值，就不显示
    ...
    public CommonDialog setContent(String content, int contentGravity) {//设置标题内容和颜色
    ...
    public CommonDialog setContent(String content, @DialogColor String contentColor, int contentGravity) {//设置标题内容和颜色
        this.content = content;
        this.contentColor = contentColor;
        this.contentGravity = contentGravity;
        return this;
